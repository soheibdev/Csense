            ...
            <div className={styles.appShell}>
                ...
                <div className={styles.mainArea}>
                    ...
                    <div className={styles.content}>
                        <p style={{ fontSize: "14px", fontWeight: "400", color: "#757575" }}>Topics  •  Social Engineering  </p>
                        <p style={{ fontSize: "32px", fontWeight: "700", color: "#212121" }}>Social Engineering</p>
                        <p style={{ fontSize: "16px", fontWeight: "400", color: "#212121" }}>Social engineering is a broad term for manipulating or influencing people to gain access to their personal information, systems, or facilities.</p>
