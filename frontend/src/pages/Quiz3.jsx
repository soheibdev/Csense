...
export default function Quiz3() {
    ...
    const questions = quizzes["password-security"];
    ...
    if (showResult) {
        ...
        return (
            <QuizResult 
                ...
                quizKey="password-security"
                nextRoute="/final-quiz"
                breadcrumb="Topics  •  Password Security  •  Quiz Result"
            />
        );
    }
            ...
            <div className={styles.appShell}>
                ...
                <div className={styles.mainArea}>
                    ...
                    <div className={styles.content}>
                        <p style={{ fontSize: "14px", fontWeight: "400", color: "#757575" }}>Topics  •  Password Security  • Quiz  </p>
