...
export default function Quiz1() {
    ...
    const questions = quizzes["what-is-csense"];
    ...
    if (showResult) {
        ...
        return (
            <QuizResult 
                ...
                quizKey="what-is-csense"
                nextRoute="/social-engineering"
                breadcrumb="Topics  •  What is CSense  •  Quiz Result"
            />
        );
    }
            ...
            <div className={styles.appShell}>
                ...
                <div className={styles.mainArea}>
                    ...
                    <div className={styles.content}>
                        <p style={{ fontSize: "14px", fontWeight: "400", color: "#757575" }}>Topics  •  What is CSense  • Quiz  </p>
